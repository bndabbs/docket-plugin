...
export const DocumentationPage = () => (
      <EuiPageContentBody>
        <EuiText>
          <p>Docket was created as part of the RockNSM project to provide a
          front-end for Google Stenographer.</p>
          <p>For more information, visit the Docket GitHub repo under the
