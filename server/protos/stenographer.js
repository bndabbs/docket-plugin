...
export const steno = ($root.steno = (() => {
  ...
  steno.Stenographer = (function() {
    ...
    (Stenographer.prototype = Object.create(
      $protobuf.rpc.Service.prototype
    )).constructor = Stenographer;
    ...
    Object.defineProperty(
      (Stenographer.prototype.retrievePcap = function retrievePcap(request, callback) {
        return this.rpcCall(
          retrievePcap,
          $root.steno.PcapRequest,
          $root.steno.PcapResponse,
          request,
          callback
        );
      }),
  ...
  steno.PcapRequest = (function() {
    ...
    PcapRequest.decode = function decode(reader, length) {
      ...
      const message = new $root.steno.PcapRequest();
    ...
    PcapRequest.verify = function verify(message) {
      ...
      if (message.chunkSize != null && message.hasOwnProperty('chunkSize'))
        if (
          !$util.isInteger(message.chunkSize) &&
          !(
            message.chunkSize &&
            $util.isInteger(message.chunkSize.low) &&
            $util.isInteger(message.chunkSize.high)
          )
        )
      ...
      if (message.maxSize != null && message.hasOwnProperty('maxSize'))
        if (
          ...
          !(
            message.maxSize &&
            $util.isInteger(message.maxSize.low) &&
            $util.isInteger(message.maxSize.high)
          )
        )
    ...
    PcapRequest.fromObject = function fromObject(object) {
      if (object instanceof $root.steno.PcapRequest) return object;
      const message = new $root.steno.PcapRequest();
      ...
      if (object.chunkSize != null)
        ...
        else if (typeof object.chunkSize === 'number') message.chunkSize = object.chunkSize;
        else if (typeof object.chunkSize === 'object')
          message.chunkSize = new $util.LongBits(
            object.chunkSize.low >>> 0,
            object.chunkSize.high >>> 0
          ).toNumber();
      if (object.maxSize != null)
        if ($util.Long) (message.maxSize = $util.Long.fromValue(object.maxSize)).unsigned = false;
          ...
          message.maxSize = new $util.LongBits(
            object.maxSize.low >>> 0,
            object.maxSize.high >>> 0
          ).toNumber();
    ...
    PcapRequest.toObject = function toObject(message, options) {
        ...
        if ($util.Long) {
          ...
          object.chunkSize =
            options.longs === String
              ...
              ? long.toNumber()
              : long;
        } else object.chunkSize = options.longs === String ? '0' : 0;
        if ($util.Long) {
          const long = new $util.Long(0, 0, false);
          object.maxSize =
            options.longs === String
      ...
      if (message.chunkSize != null && message.hasOwnProperty('chunkSize'))
        if (typeof message.chunkSize === 'number')
          object.chunkSize =
            options.longs === String ? String(message.chunkSize) : message.chunkSize;
        else
          object.chunkSize =
            options.longs === String
              ? $util.Long.prototype.toString.call(message.chunkSize)
              : options.longs === Number
              ? new $util.LongBits(
                  message.chunkSize.low >>> 0,
                  message.chunkSize.high >>> 0
                ).toNumber()
              : message.chunkSize;
      if (message.maxSize != null && message.hasOwnProperty('maxSize'))
  ...
  steno.PcapResponse = (function() {
    ...
    PcapResponse.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      const end = length === undefined ? reader.len : reader.pos + length;
      const message = new $root.steno.PcapResponse();
      while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    PcapResponse.verify = function verify(message) {
      ...
      if (message.pcap != null && message.hasOwnProperty('pcap'))
        if (
          !(
            (message.pcap && typeof message.pcap.length === 'number') ||
            $util.isString(message.pcap)
          )
        )
    ...
    PcapResponse.fromObject = function fromObject(object) {
      if (object instanceof $root.steno.PcapResponse) return object;
      const message = new $root.steno.PcapResponse();
      if (object.uid != null) message.uid = String(object.uid);
      if (object.pcap != null)
        if (typeof object.pcap === 'string')
          $util.base64.decode(
            object.pcap,
            (message.pcap = $util.newBuffer($util.base64.length(object.pcap))),
            0
          );
        else if (object.pcap.length) message.pcap = object.pcap;
      return message;
    };
    ...
    PcapResponse.toObject = function toObject(message, options) {
      ...
      if (options.defaults) {
        object.uid = '';
        if (options.bytes === String) object.pcap = '';
        else {
          object.pcap = [];
          if (options.bytes !== Array) object.pcap = $util.newBuffer(object.pcap);
        }
      }
      if (message.uid != null && message.hasOwnProperty('uid')) object.uid = message.uid;
      if (message.pcap != null && message.hasOwnProperty('pcap'))
        object.pcap =
          options.bytes === String
            ? $util.base64.encode(message.pcap, 0, message.pcap.length)
            : options.bytes === Array
            ? Array.prototype.slice.call(message.pcap)
            : message.pcap;
      return object;
    };
